...
public class EditPersonDescriptorBuilder {
    ...
    /**
     * Sets the {@code OrgID} of the {@code EditPersonDescriptor} that we are
     * building.
     */
    public EditPersonDescriptorBuilder withOrgID(String orgID) {
        descriptor.setOrgID(new OrgID(orgID));
        return this;
    }

    /**
     * Sets the {@code DeviceInfo} of the {@code EditPersonDescriptor} that we are
     * building.
     */
    public EditPersonDescriptorBuilder withDeviceInfo(String deviceInfo) {
        descriptor.setDeviceInfo(new DeviceInfo(deviceInfo));
        return this;
    }
