...
import static seedu.address.logic.commands.CommandTestUtil.VALID_DEVICEINFO_AMY;
import static seedu.address.logic.commands.CommandTestUtil.VALID_ORGID_AMY;
...
public class LogicManagerTest {
    ...
    private void assertCommandSuccess(String inputCommand, String expectedMessage, Model expectedModel)
            throws CommandException, ParseException, InvalidAccessRightsException {
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + " i/" + VALID_ORGID_AMY + " d/" + VALID_DEVICEINFO_AMY
                + TAG_DESC_FRIEND + " st/" + VALID_STATUS_AMY;
