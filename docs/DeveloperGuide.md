...
| `* * * *`                              | IT Staff         | store an organization ID and organization email associated with a contact                                                            | I can easily access the organization relevant information for our internal company processes                                                                          |
...
| `* * * *`                              | IT Staff         | search for organization members using an organization email or id                                                                    | if referring to other organization documents, I can easily reference the id or email to find a organization member in the address book                                |
